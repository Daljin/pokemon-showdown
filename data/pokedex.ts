export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	golbat: {
		...
		abilities: {0: "Inner Focus", 1: "Toxic Chain", H: "Infiltrator"},
		heightm: 1.6,
		weightkg: 55,
		color: "Purple",
		prevo: "Zubat",
	...
	ogerpon: {
		...
		tags: ["Sub-Legendary"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Ogerpon-Wellspring", "Ogerpon-Hearthflame", "Ogerpon-Cornerstone", "Ogerpon-Stormpeak", "Ogerpon-Teal-Tera", "Ogerpon-Wellspring-Tera", "Ogerpon-Hearthflame-Tera", "Ogerpon-Cornerstone-Tera", "Ogerpon-Stormpeak-Tera"],
		formeOrder: ["Ogerpon", "Ogerpon-Wellspring", "Ogerpon-Hearthflame", "Ogerpon-Cornerstone", "Ogerpon-Stormpeak", "Ogerpon-Teal-Tera", "Ogerpon-Wellspring-Tera", "Ogerpon-Hearthflame-Tera", "Ogerpon-Cornerstone-Tera", "Ogerpon-Stormpeak-Tera"],
		forceTeraType: "Grass",
	},
	ogerponwellspring: {
		num: 1017,
	...
	gastrodondelta: {
		...
		types: ["Water", "Dragon"],
		baseStats: {hp: 111, atk: 83, def: 108, spa: 72, spd: 82, spe: 39},
	...
	gholdengodelta: { //missing pearly parade, special z-move
		num: -5024,
	...
	lochtrier: { //missing signature ability
		num: -5025,
		name: "Lochtrier",
		types: ["Water"],
		gender: "N",
	...
	whirlingabyss: { //missing move: tidal trance
		num: -5026,
		name: "Whirling Abyss",
		types: ["Psychic", "Water"],
		gender: "N",
	...
	polfeegeist: {
		num: -5027, //missing unique ability and move coffee splatter
		name: "Polfeegeist",
		baseForme: "Phony",
		types: ["Ghost", "Water"],
		gender: "N",
		baseStats: {hp: 65, atk: 65, def: 132, spa: 91, spd: 85, spe: 70},
		abilities: {0: "Sheltered Slumb", H: "Insomnia"},
		heightm: 0.2,
		weightkg: 5.6,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	tinkatondelta: {
		num: -5028, //missing move
		name: "Tinkaton Delta",
		types: ["Fairy", "Water"],
		gender: "F",
		baseStats: {hp: 85, atk: 75, def: 77, spa: 70, spd: 105, spe: 94},
		abilities: {0: "Sunction Cups", 1: "Steelworker", H: "Immunity"},
		heightm: 0.7,
		weightkg: 218.5,
		color: "Pink",
		eggGroups: ["Fairy"],
	...
	greninjadelta: {
		num: -5030, //missing unique ability and move iai slash
		name: "Greninja Delta",
		types: ["Water", "Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 72, atk: 125, def: 75, spa: 83, spd: 66, spe: 109},
	...
	quaxolotl: {
		num: -5031, //missing unique ability
		name: "Quaxolotl",
		types: ["Water", "Fairy"],
		baseStats: {hp: 100, atk: 65, def: 65, spa: 55, spd: 85, spe: 60},
		abilities: {0: "Strong Pysche", 1: "Water Absorb", H: "Sheer Force"},
		heightm: 1.4,
		weightkg: 75,
		color: "Blue",
		eggGroups: ["Water 1", "Field"],
	},
	ironstorm: { //missing move: titanium tempest
		num: -5032,
		name: "Iron Storm",
		types: ["Flying", "Steel"],
		gender: "N",
		baseStats: {hp: 105, atk: 110, def: 105, spa: 110, spd: 140, spe: 90},
		abilities: {0: "Quark Drive"},
		heightm: 5.2,
		weightkg: 240,
		color: "White",
	...
	klinklangdelta: {
		num: -5034, //missing move and ability
	...
	aegislashdelta: {
		...
		evoItem: "Dusk Stone",
		eggGroups: ["Mineral"],
		otherFormes: ["Aegislash-Blade Delta"],
		formeOrder: ["Aegislash Delta", "Aegislash-Blade Delta"],
	},
	aegislashbladedelta: {
		num: -5037,
		name: "Aegislash-Blade Delta",
	...
	golurkdelta: {
		num: -5039, //missing move and ability
		name: "Golurk Delta",
		types: ["Rock", "Ghost"],
		gender: "N",
		baseStats: {hp: 89, atk: 144, def: 80, spa: 55, spd: 60, spe: 55},
	...
	tangledtime: {
		num: -5044, //missing ability and move
		name: "Tangled Time",
		types: ["Psychic", "Dragon"],
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 75, spa: 120, spd: 75, spe: 120},
	...
	magirigus: {
		num: -5059,
		name: "Magirigus", //missing ability and item
		types: ["Ghost", "Psychic"],
	...
	slaughtermaus: {
		num: -5062, //mising ability and move
		name: "Slaughtermaus",
		types: ["Dark", "Poison"],
	...
	snorlaxdelta: {
		num: -5066, //mising move
		name: "Snorlax Delta",
		baseForme: "Snow Warning", // TODO: actual base forme is Icy Snow, not Meadow
		types: ["Normal", "Grass"],
		...
		color: "Green",
		eggGroups: ["Field"],
		otherFormes: ["Snorlax-Summer", "Snorlax-Spring", "Snorlax-Autumn", "Snorlax-Cherry"],
		formeOrder: [
			"Snorlax-Summer", "Snorlax-Spring", "Snorlax-Autumn", "Snorlax-Cherry"
		],
	},
	snorlaxsummer: {
		num: -5066,
		name: "Snorlax Summar",
		baseSpecies: "Snorlax Delta",
		forme: "Summer",
		types: ["Normal", "Grass"],
		baseStats: {hp: 160, atk: 110, def: 110, spa: 65, spd: 65, spe: 30},
	...
	perrgatory: {
		num: -5079, //missing move and ability
		name: "Perrgatory",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 70, atk: 40, def: 50, spa: 100, spd: 85, spe: 100},
		abilities: {0: "Evil's Bane"},
		heightm: 1,
		weightkg: 18.5,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	ambipomdelta: {
		...
		name: "Ambipom Delta",
		types: ["Normal", "Ghost"],
		baseStats: {hp: 65, atk: 115, def: 68, spa: 56, spd: 75, spe: 103},
		abilities: {0: "Technician", 1: "Pickup", H: "Long Reach"},
		heightm: 1.2,
		weightkg: 20.3,
		color: "Purple",
		eggGroups: ["Field"],
	...
	ancieon: {
		num: -5086, //missing ability
		name: "Ancieon",
		types: ["Ground"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 110, atk: 130, def: 65, spa: 60, spd: 65, spe: 95},
		abilities: {0: "Pressue", H: "Prowler"},
		heightm: 1,
		weightkg: 25,
		color: "Black",
		eggGroups: ["Field"],
	...
	spectreon: {
		num: -5089, //missing ability and move
		name: "Spectreon",
		types: ["Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 95, atk: 60, def: 65, spa: 110, spd: 65, spe: 130},
		abilities: {0: "Tangibility", H: "Speed Boost"},
		heightm: 1,
		weightkg: 27,
		color: "Black",
		eggGroups: ["Field"],
	...
	energeist: {
		num: -5092, //missing unique ability and move prime current
		name: "Energeist",
	...
	ironrevival: {
		num: -5096, //missing move
		name: "Iron Revival",
		types: ["Electric", "Flying"],
		gender: "N",
		baseStats: {hp: 105, atk: 85, def: 1105, spa: 135, spd: 130, spe: 110},
		abilities: {0: "Quark Drive"},
		heightm: 3.8,
		weightkg: 230,
		color: "Red",
	...
	klocktowl: {
		num: -5099, //missing move
		name: "Kowltowl",
		types: ["Dark", "Flying"],
		baseStats: {hp: 145, atk: 50, def: 70, spa: 110, spd: 102, spe: 65},
	...
	ambipomultra: {
		...
		name: "Ambipom Ultra",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 75, atk: 108, def: 66, spa: 58, spd: 60, spe: 115},
		abilities: {0: "Flash Fire", 1: "Pickup", H: "Tough Claws"},
		heightm: 1.2,
		weightkg: 16.5,
		color: "Red",
		eggGroups: ["Field"],
	...
	haxorusdelta: {
		num: -5104,
		name: "Haxorus Delta", //missing move and ability
		types: ["Dragon", "Fire"],
	...
	infernapedelta: {
		...
		formeOrder: ["Infernape-Delta", "Infernape-Delta-Mega"],
	},
	infernapedeltamega: {
		num: -5106,
	...
	ogerponstormpeaktera: {
		num: -5020,
		name: "Ogerpon-Stormpeak-Tera", //missing ability
		baseSpecies: "Ogerpon",
	...
	eruptois: {
		num: -5025, //missing ability and move
		name: "Eruptois",
		types: ["Fire", "Water"],
	...
	uxiedelta: {
		num: -5026,
		name: "Uxie Delta", //missing move
		types: ["Dark", "Poison"],
		gender: "N",
		baseStats: {hp: 75, atk: 90, def: 115, spa: 90, spd: 115, spe: 95},
		abilities: {0: "Levitate", 1: "Toxic Chain", H:"Truant"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Yellow",
		tags: ["Sub-Legendary"],
	...
	mespritdelta: {
		...
		gender: "N",
		baseStats: {hp: 80, atk: 105, def: 105, spa: 105, spd: 105, spe: 80},
		abilities: {0: "Levitate", 1: "Toxic Chain", H:"Merciless"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Pink",
		tags: ["Sub-Legendary"],
	...
	azelfdelta: {
		...
		gender: "N",
		baseStats: {hp: 75, atk: 125, def: 70, spa: 125, spd: 70, spe: 115},
		abilities: {0: "Levitate", 1: "Toxic Chain", H:"Unaware"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Blue",
		tags: ["Sub-Legendary"],
	...
	gogoatdelta: {
		...
		name: "Gogoat Delta",
		types: ["Steel", "Normal"],
		baseStats: {hp: 100, atk: 123, def: 90, spa: 69, spd: 61, spe: 88},
	...
	mewthree: {
		num: -5030,
		name: "Mewthree", //missing ability and move
		types: ["Dark"],
		gender: "N",
	...
	bansherene: {
		num: -5031,
		name: "Bansherene", //missing ability and move 
		types: ["Ghost"],
		gender: "F",
	...
	tentacrueldelta: {
		num: -5032,
		name: "Tentacruel Delta", //missing move and ability
		types: ["Electric", "Poison"],
	...
	slowhost: {
		num: -5033,
		name: "Slowhost", //missing ability
		types: ["Water", "Electric"],
		baseStats: {hp: 85, atk: 75, def: 75, spa: 125, spd: 90, spe: 40},
		abilities: {0: "Unaware", 1: "Oblivious", H: "Usurped"},
		heightm: 2,
		weightkg: 116,
		color: "Pink",
		eggGroups: ["Monster", "Water 1"],
	...
	goolossal: {
		num: -5034, //missing ability
		name: "Goolossal",
		types: ["Dragon", "Fairy"],
		baseStats: {hp: 180, atk: 95, def: 96, spa: 105, spd: 88, spe: 40},
	...
	glimmoraultra: {
		...
		name: "Glimmora Ultra",
		types: ["Electric", "Fairy"],
		baseStats: {hp: 83, atk: 55, def: 75, spa: 135, spd: 91, spe: 86},
		abilities: {0: "Swift Swim", H: "Immunity"},
		heightm: 1.5,
		weightkg: 20.5,
		color: "Blue",
		eggGroups: ["Mineral"],
	...
	lopunnydelta: {
		num: -5038, //missing ability and move
		name: "Lopunny Delta",
		types: ["Dark", "Fairy"],
